...
export default async function handler(req, res) {
    ...
    try {
        ...
        await client.query("INSERT INTO login_risks (username, ip_address, network_location, device_info, fingerprint_mismatch, login_rate, risk_score, risk_level) VALUES ($1, $2, $3, $4, $5, $6, $7, $8)", [username, ip, location, device, fp_mismatch, loginRate, score, level]);
